...
The product category is used to determine which tax rate to apply to this product. This is done by identifying one of the categories from our [Product Tax Categories](/essentials/product-categories) list.
