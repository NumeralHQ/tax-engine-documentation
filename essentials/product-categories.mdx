...
These categories are used to determine which tax rate to apply to a [product](/objects/products). As you start creating `product` objects in our database, you'll need to assign one of these categories to the product.
